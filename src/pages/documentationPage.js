...
const API_ENDPOINTS = [
  ...
  },
  {
    ...
    notes: [
      ...
      "Themes: `light`, `dark`, `github`, `terminal`, `forest`, `ember`",
      "Fonts: `arial`, `system`, `verdana`, `georgia`, `mono`",
      "Color values support 3 or 6 digit hex with or without `#`; encode `#` as `%23` in URLs.",
      "Response includes `X-Embed-Cache: HIT|MISS`",
    ],
    curl: `${PUBLIC_API_BASE}/embed/MOD_UUID/card.svg?layout=history&theme=terminal&font=mono&size=md`,
    extraLabel: "Usage Example",
    extraCode: "html",
    extraSnippet: `${PUBLIC_API_BASE}/embed/MOD_UUID/card.svg?theme=dark&bg=111827&text=f9fafb&panel=1f2937&serversColor=f97316&playersColor=22c55e`,
  },
  {
    id: "developer-embed-card",
    route: "GET /embed/developer/:developer_uuid/card.svg",
    summary: "Shareable SVG analytics card aggregating public stats for a developer profile.",
    params: [
      "theme",
      "layout",
      "size",
    ...
    rateLimit: "EMBED_GET",
    notes: [
      "Uses the same layout, theme, size, font, shape, and color options as mod embeds.",
      "Live totals are de-duplicated across servers running multiple mods by the same developer.",
      "The history layout is a 30-day aggregate built from managed mod history rows.",
    ],
    curl: `${PUBLIC_API_BASE}/embed/developer/DEVELOPER_UUID/card.svg?layout=history&theme=terminal&font=mono`,
    extraLabel: "Usage Example",
    extraCode: "html",
    extraSnippet: `${PUBLIC_API_BASE}/embed/developer/DEVELOPER_UUID/card.svg?layout=stacked&theme=dark`,
  },
  {
    id: "recent-activity",
